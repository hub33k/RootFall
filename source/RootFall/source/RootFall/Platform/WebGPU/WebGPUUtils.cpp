...
namespace hub33k::WebGPU {

  wgpu::Instance CreateInstance(const wgpu::ChainedStruct *togglesChain) {
  ...
  wgpu::Adapter
  CreateAdapter(const wgpu::Instance &instance, const wgpu::Surface &surface, const wgpu::ChainedStruct *togglesChain) {
