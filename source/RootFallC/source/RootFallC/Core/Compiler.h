...
// This can help avoid common mistakes like not including "Compiler.hpp" and falling into unwanted
...
// Checks whether ASan is enabled.
  ...
  #define HK_ASAN_ENABLED() __has_feature(address_sanitizer)
    ...
    #define HK_ASAN_ENABLED() 1
  #else
    #define HK_ASAN_ENABLED() 0
  #endif
#endif
...
// HK_CONSTEXPR_DTOR
//
// Constexpr destructors were introduced in C++20. RootFall's minimum supported C++ version is C++17.
...
#if HK_HAS_ATTRIBUTE(capability)
  #define HK_MUTEX_CAPABILITY __attribute__((capability("mutex")))
#else
  #define HK_MUTEX_CAPABILITY
#endif
...
#if HK_HAS_ATTRIBUTE(scoped_lockable)
  #define HK_SCOPED_LOCKABLE __attribute__((scoped_lockable))
#else
  #define HK_SCOPED_LOCKABLE
#endif

// HK_EXCLUSIVE_LOCK_FUNCTION
//
...
#if HK_HAS_ATTRIBUTE(exclusive_lock_function)
  #define HK_EXCLUSIVE_LOCK_FUNCTION __attribute__((exclusive_lock_function()))
#else
  #define HK_EXCLUSIVE_LOCK_FUNCTION
#endif
...
//
// https://clang.llvm.org/docs/ThreadSafetyAnalysis.html#acquire-acquire-shared-release-release-shared-release-generic
#if HK_HAS_ATTRIBUTE(unlock_function)
  #define HK_UNLOCK_FUNCTION __attribute__((unlock_function()))
#else
  #define HK_UNLOCK_FUNCTION
#endif

// HK_NO_THREAD_SAFETY_ANALYSIS
//
...
#if HK_HAS_ATTRIBUTE(no_thread_safety_analysis)
  #define HK_NO_THREAD_SAFETY_ANALYSIS __attribute__((no_thread_safety_analysis))
#else
  #define HK_NO_THREAD_SAFETY_ANALYSIS
#endif
